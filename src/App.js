...
import RegisterpageRe from './Pages/RegesterPageRe';
...
function App(){
  ...
  return (
    ...
    <Routes>
          ...
          <Route path="/home"index element={<PrivateRouter user={user} > <Home />  </PrivateRouter>}  />  
         <Route path="/RecruterHome"index element={ <PrivateRouter user={user} > <RecruterHome />  </PrivateRouter>}  />  
          <Route path="/*" element={<NotFoundPage />} />
          <Route path="noaccess" element={<NoAccess />} />
          <Route path="login" element={<ForceRdirect user={user}><LoginPage/></ForceRdirect>} />
          <Route path="registerRec" element={<ForceRdirect user={user}><RegisterpageRe/></ForceRdirect>} />
