...
function Certification (props) {
  ...
  return (
        ...
        <div className='    m-2 h-14 w-60 l'>
            <input   onChange={props.onChangeHandler} className='mt-1 shadow-md w-60 h-14' placeholder='certif name....' type ="text" name='name'  />
            ...
            <input onChange={props.onChangeHandler}  className='pl-6 shadow-md mt-1 w-60 h-14' type="date"  defaultValue={new Date()} name="AquisationDate" placeholder='Aquisation date'/>
